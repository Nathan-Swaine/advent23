import sys,re,heapq, math, copy, collections
from copy import deepcopy
from math import gcd
from collections import defaultdict, Counter, deque
def lowestcommonmul(xs):
  ans = 1
  for x in xs:
...
def main():
  ...
  Line = Data.split('\n')
  G = [[c for c in row] for row in Line]
  R = len(G)
  C = len(G[0])
